    ...
    <aside className="fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-white/[0.06] bg-[oklch(0.09_0.015_264)] lg:static">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-white/[0.06] px-5">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-white leading-none">AI Club</span>
          <span className="text-[10px] text-white/40 leading-none mt-0.5">Content Dashboard</span>
        </div>
      </div>
